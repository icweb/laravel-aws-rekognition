...
<div class="container">
    ...
    <div class="jumbotron">
        <h3>Laravel + AWS Rekognition Integration</h3>
        <p>This project demonstrates the integration of the AWS SDK for PHP Rekognition client into a Laravel project.</p>
